...
//  product ID and a firmware version are included in the compiled binary. Specifically, 
//  you must add PRODUCT_ID([your product ID]) and PRODUCT_VERSION([version]) into the 
//  application code of your firmware.
PRODUCT_ID(11211);
PRODUCT_VERSION(1);
...
const Data DEFAULT_DATA = {
  ...
  /* version */ 0,
  /* intervalCounter */ 0.0,
  /* intervalLimit */ 1.0, // <-------------------------- number of miles driven before the device sends a message
  /* intervalReached */ 0,
};
